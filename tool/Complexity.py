...
How to use:
    ...
    python Complexity.py --model_name bformer --mode test --n_colors 3  --patch_size 96 --patch_dim 3 --num_heads 9 --num_layers 8 --n_GPUs 1 --GPU_id 2
To measure：
|——Number of parameters——Param
 ——Computational complexity——GFLOPs

CMD:
python Complexity.py --model_name bformer --mode test --n_colors 3  --patch_size  --patch_dim 3 --num_heads 9 --num_layers 8 --n_GPUs 1 --GPU_id 2
