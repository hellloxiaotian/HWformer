...
CMD: python complexity_ipt.py --model_name ipt --mode test --n_colors 3  --patch_size 48 --patch_dim 3 --num_heads 12 --num_layers 12 --n_GPUs 1 --GPU_id 2
...
with torch.no_grad():
    ...
    macs, params = get_model_complexity_info(_model,
                                             ...
                                             verbose=True)
    print('{:<30}   {:<8}'.format('Computational complexity(GFLOPs):', macs/(1e9)))
